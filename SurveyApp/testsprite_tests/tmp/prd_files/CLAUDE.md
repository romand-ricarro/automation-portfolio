...
Survey Analytics Platform - A full-stack web application for analyzing training survey data using AI. The platform pulls data from Google Sheets (Google Forms responses), uses OpenAI GPT-4o to analyze open-ended feedback, and identifies common issues and patterns across sessions.
